...
export default function Page() {
  ...
  const handleDelete = (id)=>{
    Alert.alert("Delete Transation","Are you sure you want to delete this transaction?",[
      ...
      <View style={styles.content}>
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            <Image source={require('../../assets/images/Wallet App Logo.png') }
        ...
        <View style={styles.headerRight}>
          <TouchableOpacity
          style={styles.addButton} onPress={()=>router.push("/create")}
          >
